 ...
 */
@Service
public class DefaultLinkDataMapServiceImpl implements LinkDataMapService {
    private final MapStatisticsCallerDao mapStatisticsCallerDao;
    private final MapStatisticsCalleeDao mapStatisticsCalleeDao;

    public DefaultLinkDataMapServiceImpl(@Qualifier("hbaseMapStatisticsCallerDao") MapStatisticsCallerDao mapStatisticsCallerDao, @Qualifier("hbaseMapStatisticsCalleeDao") MapStatisticsCalleeDao mapStatisticsCalleeDao) {
