 ...
 * @author jaehong.kim
 */
public abstract class BaseResponseTimeHistogramServiceImpl implements ResponseTimeHistogramService {
    ...
    public BaseResponseTimeHistogramServiceImpl(LinkSelectorFactory linkSelectorFactory,
        ...
        this.mapResponseService = Objects.requireNonNull(mapResponseService, "mapResponseDao");
    ...
    public ApplicationTimeHistogramViewModel selectResponseTimeHistogramData(Application application, Range range) {
        List<ResponseTime> responseTimes = mapResponseService.selectResponseTime(application, range);
    ...
    public NodeHistogramSummary selectNodeHistogramData(Application application, Range range, List<Application> fromApplications, List<Application> toApplications) {
        ...
        if (applicationServiceType.isWas()) {
            ...
            ServerInstanceList serverInstanceList = serverInstanceListFactory.createWasNodeInstanceList(node, range);
            ...
            if (sourceApplications.isEmpty()) {
                return createEmptyNodeHistogramSummary(serverInstanceListFactory, application, range);
            }
