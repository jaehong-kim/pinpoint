 ...
 */
@Component
public class DefaultLinkSelectorFactory extends BaseLinkSelectorFactory {

    @Autowired(required = false)
    public DefaultLinkSelectorFactory(
            @Qualifier("defaultLinkDataMapServiceImpl") LinkDataMapService linkDataMapService,
