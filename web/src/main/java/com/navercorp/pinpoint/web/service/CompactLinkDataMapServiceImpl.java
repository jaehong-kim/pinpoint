 ...
 */
@Service
public class CompactLinkDataMapServiceImpl implements LinkDataMapService {
    private final MapStatisticsCallerDao mapStatisticsCallerDao;
    private final MapStatisticsCalleeDao mapStatisticsCalleeDao;

    public CompactLinkDataMapServiceImpl(@Qualifier("hbaseMapStatisticsCallerCompactDao") MapStatisticsCallerDao mapStatisticsCallerDao, @Qualifier("hbaseMapStatisticsCalleeCompactDao") MapStatisticsCalleeDao mapStatisticsCalleeDao) {
