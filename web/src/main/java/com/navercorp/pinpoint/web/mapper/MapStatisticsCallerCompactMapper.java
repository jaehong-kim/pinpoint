 ...
 */
@Component
public class MapStatisticsCallerCompactMapper implements RowMapper<LinkDataMap> {
    ...
    public MapStatisticsCallerCompactMapper() {
        this(SkipLinkFilter.FILTER);
    }

    public MapStatisticsCallerCompactMapper(LinkFilter filter) {
    ...
    public LinkDataMap mapRow(Result result, int rowNum) throws Exception {
        ...
        for (Cell cell : result.rawCells()) {
            ...
            linkDataMap.addLinkData(caller, callee, calleeHost, timestamp, slotTime, requestCount);
        }
        return linkDataMap;
    }
