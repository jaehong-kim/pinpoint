 ...
 */
@Service
public class DefaultMapResponseService implements MapResponseService {
    private final MapResponseDao mapResponseDao;

    public DefaultMapResponseService(@Qualifier("hbaseMapResponseTimeDao") MapResponseDao mapResponseDao) {
