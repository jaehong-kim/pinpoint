 ...
 */
@Service
public class DefaultFilteredMapServiceImpl extends BaseFilteredMapServiceImpl {

    public DefaultFilteredMapServiceImpl(AgentInfoService agentInfoService,
        ...
        super(new AgentInfoServerInstanceListDataSource(agentInfoService), traceDao, applicationTraceIndexDao, registry, applicationFactory, serverMapDataFilter, applicationMapBuilderFactory);
    }
}