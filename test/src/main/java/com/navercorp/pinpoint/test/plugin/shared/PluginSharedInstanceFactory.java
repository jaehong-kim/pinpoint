...
import com.navercorp.pinpoint.test.plugin.classloader.PluginSharedClassLoader;
...
public class PluginSharedInstanceFactory {
    ...
    public PluginSharedInstance create(String testClassName, String sharedClassName, List<String> libs) throws ClassNotFoundException {
        ...
        final ClassLoader classLoader = new PluginSharedClassLoader(urls, Thread.currentThread().getContextClassLoader());
