 ...
 * @author jaehong.kim
 */
public class HttpMethodBaseReadResponseMethodInterceptor extends HttpMethodBaseRequestAndResponseMethodInterceptor {

    public HttpMethodBaseReadResponseMethodInterceptor(TraceContext traceContext, MethodDescriptor methodDescriptor, InterceptorScope interceptorScope) {
