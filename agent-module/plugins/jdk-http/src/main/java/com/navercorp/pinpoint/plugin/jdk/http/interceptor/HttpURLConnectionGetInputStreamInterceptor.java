...
public class HttpURLConnectionGetInputStreamInterceptor extends AbstractHttpURLConnectionInterceptor {
    public HttpURLConnectionGetInputStreamInterceptor(TraceContext traceContext, MethodDescriptor descriptor, InterceptorScope scope) {
