...
public class HttpURLConnectionGetOutputStreamInterceptor extends AbstractHttpURLConnectionInterceptor {

    public HttpURLConnectionGetOutputStreamInterceptor(TraceContext traceContext, MethodDescriptor descriptor, InterceptorScope scope) {
