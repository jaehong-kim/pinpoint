...
public class HttpsURLConnectionImplGetOutputStreamInterceptor extends AbstractHttpURLConnectionInterceptor {

    public HttpsURLConnectionImplGetOutputStreamInterceptor(TraceContext traceContext, MethodDescriptor descriptor, InterceptorScope scope) {
