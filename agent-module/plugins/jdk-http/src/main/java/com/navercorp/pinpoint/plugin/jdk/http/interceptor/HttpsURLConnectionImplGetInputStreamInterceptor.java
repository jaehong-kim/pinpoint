...
public class HttpsURLConnectionImplGetInputStreamInterceptor extends AbstractHttpURLConnectionInterceptor {

    public HttpsURLConnectionImplGetInputStreamInterceptor(TraceContext traceContext, MethodDescriptor descriptor, InterceptorScope scope) {
