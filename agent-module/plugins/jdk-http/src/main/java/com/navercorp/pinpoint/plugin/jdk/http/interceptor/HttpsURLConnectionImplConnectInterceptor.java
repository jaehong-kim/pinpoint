...
public class HttpsURLConnectionImplConnectInterceptor extends AbstractHttpURLConnectionInterceptor {

    public HttpsURLConnectionImplConnectInterceptor(TraceContext traceContext, MethodDescriptor descriptor, InterceptorScope scope) {
