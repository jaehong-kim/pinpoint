 ...
 * @author jaehong.kim
 */
public class ExceptionHandleMethodDescriptorAwareAroundInterceptor implements MethodDescriptorAwareAroundInterceptor {

    private final MethodDescriptorAwareAroundInterceptor delegate;
    private final ExceptionHandler exceptionHandler;

    public ExceptionHandleMethodDescriptorAwareAroundInterceptor(MethodDescriptorAwareAroundInterceptor delegate, ExceptionHandler exceptionHandler) {
