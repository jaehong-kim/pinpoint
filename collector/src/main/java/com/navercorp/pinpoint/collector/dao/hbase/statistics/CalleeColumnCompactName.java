 ...
 * @author jaehong.kim
 */
public class CalleeColumnCompactName implements ColumnName {
    ...
    public CalleeColumnCompactName(short calleeServiceType, String calleeApplicationName, String callHost, short columnSlotNumber) {
    ...
    public boolean equals(Object o) {
        ...
        CalleeColumnCompactName that = (CalleeColumnCompactName) o;
    ...
    public int hashCode() {
        ...
        int result = calleeApplicationName.hashCode();
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("CalleeColumnCompactName{");
