...
public class KeepAliveService {
    ...
    protected AgentProperty newChannelProperties(Header header, short serviceTypeCode) {
        final String agentId = header.getAgentId();
        final long agentStartTime = header.getAgentStartTime();
        return new DefaultAgentProperty(header.getApplicationName(), serviceTypeCode, agentId, agentStartTime, header.getProperties());
    }
