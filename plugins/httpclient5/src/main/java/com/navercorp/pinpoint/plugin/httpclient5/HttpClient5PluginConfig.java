...
public class HttpClient5PluginConfig {
    ...
    private final List<String> httpClientResponseHandlerBasePackageNames;
    ...
    public HttpClient5PluginConfig(ProfilerConfig src) {
        ...
        this.io = src.readBoolean("profiler.apache.httpclient5.io", true);

        this.httpClientResponseHandlerBasePackageNames = src.readList("profiler.apache.httpclient5.response.handler.base-packages");
    }
    ...
    public List<String> getHttpClientResponseHandlerBasePackageNames() {
        return httpClientResponseHandlerBasePackageNames;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("HttpClient5PluginConfig{");
