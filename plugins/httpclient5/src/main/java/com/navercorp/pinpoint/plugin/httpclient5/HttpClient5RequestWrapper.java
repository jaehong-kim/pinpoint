...
public class HttpClient5RequestWrapper implements ClientRequestWrapper {
    ...
    public HttpClient5RequestWrapper(final HttpRequest httpRequest, final String hostName, final int port) {
    ...
    public String getUrl() {
        final String requestLine = this.httpRequest.getRequestUri();
        if (requestLine != null) {
            return requestLine;
        }
        return null;
