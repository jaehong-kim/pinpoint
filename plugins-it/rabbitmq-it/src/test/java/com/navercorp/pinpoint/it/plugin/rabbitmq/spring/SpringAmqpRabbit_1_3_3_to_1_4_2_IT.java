...
import test.pinpoint.plugin.rabbitmq.spring.config.MessageListenerConfig_Pre_1_4_0;
import test.pinpoint.plugin.rabbitmq.spring.config.ReceiverConfig_Pre_1_6_0;
...
@Dependency({"org.springframework.amqp:spring-rabbit:[1.4.0.RELEASE,1.4.2.RELEASE)", "com.fasterxml.jackson.core:jackson-core:2.8.11", "org.apache.qpid:qpid-broker:6.1.1"})
