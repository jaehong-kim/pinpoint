...
@Dependency({"org.postgresql:postgresql:[42.0.0,42.2.15.jre6),[42.2.15.jre7,42.2.22.jre6),[42.2.22.jre7,)",
...
public class PostgreSql_Post_42_IT extends PostgreSqlBase {
    ...
    private static void invalidJarCheck() {
        ClassLoader classLoader = PostgreSql_Post_42_IT.class.getClassLoader();
