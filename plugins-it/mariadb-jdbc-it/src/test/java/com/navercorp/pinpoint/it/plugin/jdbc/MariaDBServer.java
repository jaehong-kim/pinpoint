...
//        mariaDB.withUrlParam("noAccessToProcedureBodies", "true");
        ...
        System.setProperty("JDBC_URL", mariaDB.getJdbcUrl());
        System.setProperty("USER", mariaDB.getUsername());
        System.setProperty("PASSWORD", mariaDB.getPassword());
        System.setProperty("HOST", mariaDB.getHost());
        System.setProperty("PORT", mariaDB.getFirstMappedPort().toString());

        try {
            System.setProperty("DATABASE", mariaDB.getDatabaseName());
