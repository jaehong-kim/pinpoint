 ...
 */
public class MariaDB_1_8_0_DriverClass extends AbstractJDBCDriverClass {
    private final PreparedStatementType type;

    public MariaDB_1_8_0_DriverClass(PreparedStatementType type) {
        this.type = type;
    }
    ...
    public Class<PreparedStatement> getPreparedStatement() {
        if (type == PreparedStatementType.Server) {
            return forName("org.mariadb.jdbc.ServerSidePreparedStatement");
        } else  {
            return forName("org.mariadb.jdbc.ClientSidePreparedStatement");
        }
    }
