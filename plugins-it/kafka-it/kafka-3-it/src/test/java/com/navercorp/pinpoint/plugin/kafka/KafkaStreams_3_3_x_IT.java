...
@Dependency({
        "org.apache.kafka:kafka_2.12:[3.3.0]", "log4j:log4j:[1.2.17]", "commons-io:commons-io:[2.5.0]",
        "org.apache.kafka:kafka-clients:[3.3.0]", "org.apache.kafka:kafka-streams:[3.3.0,3.3.max]",
        TestcontainersOption.TEST_CONTAINER, TestcontainersOption.KAFKA
})
@JvmVersion(8)
@SharedTestLifeCycleClass(KafkaStreamsUnitServer.class)
public class KafkaStreams_3_3_x_IT extends KafkaStreamsIT {
    @Test
    @Disabled
