...
@Dependency({
        "org.apache.kafka:kafka_2.12:[3.4.0]", "log4j:log4j:[1.2.17]", "commons-io:commons-io:[2.5.0]",
        "org.apache.kafka:kafka-clients:[3.4.0]", "org.apache.kafka:kafka-streams:[3.4.0,3.max]",
        TestcontainersOption.TEST_CONTAINER, TestcontainersOption.KAFKA
})
@JvmVersion(8)
@SharedTestLifeCycleClass(KafkaStreamsUnitServer.class)
public class KafkaStreams_3_4_x_IT extends KafkaStreamsIT {
    @Test
    @Disabled
