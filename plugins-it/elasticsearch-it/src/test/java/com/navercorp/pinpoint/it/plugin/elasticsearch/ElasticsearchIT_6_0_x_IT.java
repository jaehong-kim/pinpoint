...
//@Dependency({"org.elasticsearch.client:elasticsearch-rest-high-level-client:[6.0.0,6.3.0)","org.elasticsearch:elasticsearch-core:6.2.0"})
@Dependency({"org.elasticsearch.client:elasticsearch-rest-high-level-client:[6.0.0]","org.elasticsearch:elasticsearch-core:6.2.0"})
@SharedDependency(TestcontainersOption.ELASTICSEARCH)
