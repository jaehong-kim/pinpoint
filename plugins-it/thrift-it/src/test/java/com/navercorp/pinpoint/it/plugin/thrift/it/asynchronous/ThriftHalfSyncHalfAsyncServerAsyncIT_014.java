...
package com.navercorp.pinpoint.it.plugin.thrift.it.asynchronous;
...
import com.navercorp.pinpoint.it.plugin.thrift.common.server.AsyncEchoTestServer014;
...
public class ThriftHalfSyncHalfAsyncServerAsyncIT_014 extends EchoTestRunner<ThriftEchoTestServer<THsHaServer>> {
    ...
    protected ThriftEchoTestServer<THsHaServer> createEchoServer(TestEnvironment environment) throws TTransportException {
        return AsyncEchoTestServer014.AsyncEchoTestServerFactory.halfSyncHalfAsyncServer(environment);
    }
