...
package com.navercorp.pinpoint.it.plugin.cxf;
...
@Dependency({"org.apache.cxf:cxf-rt-rs-client:[3.6.0,3.max)","org.apache.cxf:cxf-rt-ws-policy:[3.6.0]","org.apache.cxf:cxf-rt-frontend-jaxws:3.0.16",WebServer.VERSION})
...
public class CxfClient_3_6_x_IT {
    ...
    public static void beforeClass() throws Exception {
        ...
        System.out.println("##beforeClass WebServer=" + webServer);
    }
    ...
    public static void afterClass() throws Exception {
        ...
        System.out.println("##afterClass WebServer=" + webServer);
    }
